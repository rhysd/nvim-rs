...
I'd love contributions, comments, praise, criticism... You could open an [issue](https://github.com/rhysd/nvim-rs/issues) or a [pull request](https://github.com/rhysd/nvim-rs/pulls). I also read the subreddits for [rust](https://www.reddit.com/r/rust/), if that suits you better.
