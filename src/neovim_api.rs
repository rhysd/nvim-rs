...
impl<H: Handler> Window<H> {
    ...
    /// since: 6
    pub async fn get_config(&self) -> Result<Vec<(Value, Value)>, Box<CallError>> {
        self.neovim
    ...
    /// since: 1
    pub async fn set_cursor(&self, pos: (i64, i64)) -> Result<(), Box<CallError>> {
        self.neovim
            .call(
                "nvim_win_set_cursor",
...
impl<H: Handler> Neovim<H> {
    pub async fn get_autocmds(
        ...
        self.call("nvim_get_autocmds", call_args![opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn create_autocmd(
        ...
        self.call("nvim_create_autocmd", call_args![event, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn del_autocmd(&self, id: i64) -> Result<(), Box<CallError>> {
        self.call("nvim_del_autocmd", call_args![id])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn clear_autocmds(&self, opts: Vec<(Value, Value)>) -> Result<(), Box<CallError>> {
        self.call("nvim_clear_autocmds", call_args![opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn create_augroup(
        ...
        self.call("nvim_create_augroup", call_args![name, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn del_augroup_by_id(&self, id: i64) -> Result<(), Box<CallError>> {
        self.call("nvim_del_augroup_by_id", call_args![id])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn del_augroup_by_name(&self, name: &str) -> Result<(), Box<CallError>> {
        self.call("nvim_del_augroup_by_name", call_args![name])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn exec_autocmds(
        ...
        self.call("nvim_exec_autocmds", call_args![event, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn parse_cmd(
        ...
        self.call("nvim_parse_cmd", call_args![str, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn cmd(
        ...
        self.call("nvim_cmd", call_args![cmd, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn create_user_command(
        ...
        self.call("nvim_create_user_command", call_args![name, command, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn del_user_command(&self, name: &str) -> Result<(), Box<CallError>> {
        self.call("nvim_del_user_command", call_args![name])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn exec(&self, src: &str, output: bool) -> Result<String, Box<CallError>> {
        self.call("nvim_exec", call_args![src, output])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_option_info(&self, name: &str) -> Result<Vec<(Value, Value)>, Box<CallError>> {
        self.call("nvim_get_option_info", call_args![name])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn notify(
        ...
        self.call("nvim_notify", call_args![msg, log_level, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn set_decoration_provider(
        ...
        self.call("nvim_set_decoration_provider", call_args![ns_id, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_option_value(
        ...
        self.call("nvim_get_option_value", call_args![name, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn set_option_value(
        ...
        self.call("nvim_set_option_value", call_args![name, value, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_all_options_info(&self) -> Result<Vec<(Value, Value)>, Box<CallError>> {
        self.call("nvim_get_all_options_info", call_args![])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_option_info2(
        ...
        self.call("nvim_get_option_info2", call_args![name, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn ui_pum_set_height(&self, height: i64) -> Result<(), Box<CallError>> {
        self.call("nvim_ui_pum_set_height", call_args![height])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn ui_term_event(&self, event: &str, value: Value) -> Result<(), Box<CallError>> {
        self.call("nvim_ui_term_event", call_args![event, value])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_hl_id_by_name(&self, name: &str) -> Result<i64, Box<CallError>> {
        self.call("nvim_get_hl_id_by_name", call_args![name])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_hl(
        ...
        self.call("nvim_get_hl", call_args![ns_id, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn set_hl(
        ...
        self.call("nvim_set_hl", call_args![ns_id, name, val])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_hl_ns(&self, opts: Vec<(Value, Value)>) -> Result<i64, Box<CallError>> {
        self.call("nvim_get_hl_ns", call_args![opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn set_hl_ns(&self, ns_id: i64) -> Result<(), Box<CallError>> {
        self.call("nvim_set_hl_ns", call_args![ns_id])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn set_hl_ns_fast(&self, ns_id: i64) -> Result<(), Box<CallError>> {
        self.call("nvim_set_hl_ns_fast", call_args![ns_id])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn feedkeys(
        ...
        self.call("nvim_feedkeys", call_args![keys, mode, escape_ks])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn exec_lua(&self, code: &str, args: Vec<Value>) -> Result<Value, Box<CallError>> {
        self.call("nvim_exec_lua", call_args![code, args])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_runtime_file(
        ...
        self.call("nvim_get_runtime_file", call_args![name, all])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn echo(
        ...
        self.call("nvim_echo", call_args![chunks, history, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn chan_send(&self, chan: i64, data: &str) -> Result<(), Box<CallError>> {
        self.call("nvim_chan_send", call_args![chan, data])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn paste(&self, data: &str, crlf: bool, phase: i64) -> Result<bool, Box<CallError>> {
        self.call("nvim_paste", call_args![data, crlf, phase])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn put(
        ...
        self.call("nvim_put", call_args![lines, typ, after, follow])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_context(
        ...
        self.call("nvim_get_context", call_args![opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn load_context(&self, dict: Vec<(Value, Value)>) -> Result<Value, Box<CallError>> {
        self.call("nvim_load_context", call_args![dict])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn del_mark(&self, name: &str) -> Result<bool, Box<CallError>> {
        self.call("nvim_del_mark", call_args![name])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn get_mark(
        ...
        self.call("nvim_get_mark", call_args![name, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn eval_statusline(
        ...
        self.call("nvim_eval_statusline", call_args![str, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
    ...
    pub async fn exec2(
        ...
        self.call("nvim_exec2", call_args![src, opts])
            .await??
            .try_unpack()
            .map_err(|v| Box::new(CallError::WrongValueType(v)))
    }
